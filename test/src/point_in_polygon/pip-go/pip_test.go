...
func TestPip(t *testing.T) {
	...
	pt0 := pip.Point{X: 1.0, Y: 1.0} // Should be true
	...
	assert(pip.PointInPolygon(pt0, rectangle), true, t)
...
func TestPip2(t *testing.T) {
	rectangle := pip.Polygon{
		Points: []pip.Point{
			...
			pip.Point{X: 1.0, Y: 2.0},
			pip.Point{X: 2.0, Y: 2.0},
			pip.Point{X: 3.0, Y: 3.0},
			pip.Point{X: 4.0, Y: 2.0},
			pip.Point{X: 4.0, Y: 1.0},
			pip.Point{X: 2.0, Y: 0.0},
		},
	}
	pt0 := pip.Point{X: 3.0, Y: 2.0} // Should be true
